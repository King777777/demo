...
import { Usage as NormalCompoundComponent } from "./patterns/normal-compound-component/Usage";
import { Usage as NormalHooksCompoundComponent } from "./patterns/normal-hooks-compound-component/Usage";
...
export default function App() {
  return (
    <StyledContainer>
      ...
      <StyledPatternContainer>
        <h2>Normal Compound component pattern</h2>
        <NormalCompoundComponent />
      </StyledPatternContainer>
      <StyledPatternContainer>
        <h2>Normam Hooks Pattern</h2>
        <NormalHooksCompoundComponent />
      </StyledPatternContainer>
